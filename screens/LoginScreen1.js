  ...
  return (
    <View style={styles.container}>
      ...
      <View style={styles.Up}>
        <Text style={styles.separatorText}> ผู้ประกอบการ </Text>
      </View>
      ...
      <TouchableOpacity style={styles.customButton} onPress={handleRegisterProfile}>
      ...
      <TouchableOpacity style={styles.loginButton1} onPress={handleSignUp1}>
