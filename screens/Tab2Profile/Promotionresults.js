...
import { View, Text,Animated, TextInput, Image, Switch, TouchableOpacity, StyleSheet, FlatList, Linking, ScrollView, Modal } from 'react-native';
...
const Promotiondetails = ({ navigation, route }) => {
    ...
    const handleGoToAdvertise = () => {
       
        navigation.navigate('Advertise', { initialPage: 2 }); 
      };
            ...
            <View style={styles.container1_3} >
                    <View style={styles.container1}>
                        ...
                        <View style={styles.Area1}>
                            <Text style={styles.paragraph1}>โปรโมทงานสำเร็จ</Text>
                            <Text style={styles.paragraph2}>โอกาสของคุณที่จะได้รับความสนใจจากผู้หางาน มาถึงคุณแล้ว!</Text>
                        ...
                        <View style={styles.container2}>
                            <TouchableOpacity style={styles.loginButton} onPress={handleGoToAdvertise}>
                                <Text style={styles.loginButtonText}>ดูโฆษณาโปรโมท</Text>
                            </TouchableOpacity>
