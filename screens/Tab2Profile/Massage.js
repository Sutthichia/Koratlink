...
const ChatListScreen = () => {
  ...
  useFocusEffect(
    useCallback(() => {
      ...
      const updatedChats = [
        { id: '1', name: 'อนันต์ พิริยากร', lastMessage: 'สวัสดีค่ะผมชื่อ อนันต์ พิริยากร จะมาสมัครตำแหน่งหัวงาน', time: '10:30', read: true, image: require('../../images/profile/image (2).png') },
        { id: '2', name: 'อนุชา งามวงศ์', lastMessage: 'สวัสดีค่ะผมชื่อ อนุชา งามวงศ์ ', time: '9:15', read: false, image: require('../../images/profile/image (2).png') },
        { id: '3', name: 'ดาริน พิลาณี', lastMessage: 'สวัสดีค่ะผมชื่อ ดาริน พิลาณี จะมาสมัครตำแหน่งหัวงาน', time: '10:30', read: true, image: require('../../images/profile/image (2).png') },
        { id: '4', name: 'ชลดา สุดศิริกุล', lastMessage: 'สวัสดีค่ะผมชื่อ ชลดา สุดศิริกุล ', time: '9:15', read: false, image: require('../../images/profile/image (2).png') },
      ];
