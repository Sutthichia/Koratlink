...
const NotificationScreen = () => {
    ...
    const [notifications, setNotifications] = useState([
        { id: '1', title: 'THE MALL GROUP ', read: true, image: require('../../../images/Logo1/image-4.png'), showDetails: false, additionalText: 'ขอแสดงความยินดี ! คุณผ่านเข้ารอบสัมภาษณ์ บริษัทต้องการ..', time: '1 ชั่วโมง' },
        { id: '2', title: '2 บริษัทที่กำลังเปิดรับตำแหน่ง UX/UI...', read: true, image: require('../../../images/Logo1/image-6.png'), showDetails: true, time: '12 ชั่วโมง' },
        { id: '3', title: 'Thai Beverage Plc', read: false, image: require('../../../images/Logo1/image-1.png'), showDetails: true, additionalText: 'คำขอเลื่อนนัดสัมภาษณ์ของคุณถูกปฏิเสธ', time: '2 วัน' },
        { id: '4', title: 'KoratLink', read: true, image: require('../../../images/Logo1/Gemini.png'), showDetails: false, additionalText: 'คุณมีการเข้าชมโปรไฟล์ 52 ครั้ง ในสัปดาห์นี้', time: '3 วัน' },
    ]);
